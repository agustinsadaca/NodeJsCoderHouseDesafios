import fs from 'fs'
 ...
 class Carrito {
    constructor() {}
    async createCarrito(carritoItem) {
        let maxId = 0
        maxId = await fs.promises
            .readFile('./backend/services/archivo/carrito.json', 'utf-8')
            .then((data) => {
                ...
                fs.writeFile(
                    './backend/services/archivo/carrito.json',
    ...
    async deleteCarrito(id,idProduct) {
